 ...
 <div class="row mt-3">
  ...
  <div class="col-md-4">
    <div class="card">
        ...
        <div class="card-body">
            <p><i class="fas fa-people-carry mr-2"></i><span id="chofepart"></span></p>
            <button class="btn btn-success w-100" onclick="crearPartida()"><i class="fas fa-save mr-2"></i>GENERAR PARTIDA</button>
        </div>
    </div>
  </div>
